library(tidyverse)
data <- read.csv("/private10/Projects/Efi/AML/NeoEpitopesAnalyze/netMHCcombined.csv")
data_long <- data %>%
...
levels(data_long$Group)[1] <- 'NoTreatment' # change 'SF Mutation' group into 'NoTreatment'
treatments_desired_order <- c("NoTreatment", "Mock_6h", "Indisulam", "Pladienolide-B", "Mock_18h", "5-Azacytidine", "FB23-2")
